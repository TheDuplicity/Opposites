...
public class Client : MonoBehaviour
{
    ...
    void HandleReceive(SocketAsyncEventArgs args)
    {
        ...
        int numbersend = BitConverter.ToInt32(args.Buffer, 4);
    ...
    void Update()
    {
        ...
        foreach (KeyValuePair<float,bool> timeThreshold in m_idleMessageTimeThresholds)
        {
            if (m_timeSinceLastReceivedPacket >= timeThreshold.Key)
            {
